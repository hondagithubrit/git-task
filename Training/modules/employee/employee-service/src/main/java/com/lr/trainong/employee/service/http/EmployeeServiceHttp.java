...
public class EmployeeServiceHttp {
	...
	public static com.lr.trainong.employee.model.Employee addEmployeeDetails(
		HttpPrincipal httpPrincipal, String name, String address, long salary,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, name, address, salary, phoneNo, emailAddress);
			...
			return (com.lr.trainong.employee.model.Employee)returnObj;
		}
