...
import com.lr.trainong.employee.model.EmployeeModel;
import com.lr.trainong.employee.model.EmployeeSoap;
...
public class EmployeeModelImpl
	...
	static {
		...
		attributeGetterFunctions.put("doi", Employee::getDoi);
		attributeSetterBiConsumers.put(
			"doi", (BiConsumer<Employee, Date>)Employee::setDoi);
	...
	public CacheModel<Employee> toCacheModel() {
		...
		if (doi != null) {
			employeeCacheModel.doi = doi.getTime();
		}
		else {
			employeeCacheModel.doi = Long.MIN_VALUE;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("doi", _doi);
	}
